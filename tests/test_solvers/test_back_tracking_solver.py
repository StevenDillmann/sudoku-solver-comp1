from src.solvers import back_tracking_solver
...
# === MAIN FUNCTION TESTS =====================================================
"""!@file test_back_tracking_solver.py
    @brief Module containing tests for the back_tracking_solver module.

    @details This script contains tests for the back_tracking_solver module.
    It tests the following function: solve_sudoku_bt.
...
def test_solve_sudoku_bt(sudoku_files, expected_solved):
    """!@brief Test solve_sudoku_bt function.

    @details This function tests the solve_sudoku_bt function. It
    ...
    assert (
        back_tracking_solver.solve_sudoku_bt(sudoku_not_yet_solved)
        == expected_solved
    )
